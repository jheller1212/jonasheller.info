      ...
      <main id="main-content" className="font-[family-name:var(--font-geist-sans)] pt-24 pb-24 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            >
              {t("speakingPage.heading")}
            </h1>
            <p className="text-lg leading-relaxed" style={{ color: "var(--color-text-secondary)" }}>
              {t("speakingPage.intro")}
            </p>
          </motion.div>
          ...
          <motion.p
            ...
            className="mt-8 max-w-3xl text-sm sm:text-base leading-relaxed"
            style={{ color: "var(--color-text-secondary)" }}
          >
            {t("speakingPage.tailored")}
          </motion.p>
