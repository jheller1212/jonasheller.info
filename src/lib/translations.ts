...
/**
 * All UI strings, keyed by string key -> { en, de, nl }. Co-locating the three
 * locales per key (rather than per-locale files) means a missing translation
 * is visible at the definition site. Logic lives in i18n.tsx.
 */
export const translations: TranslationMap = {
  ...
  "trusted.2": {
    ...
    de: "Niederländisches Ministerium für I&W",
  ...
  // "Under Review" / "Revise and Resubmit" are deliberately left in English for
  // de/nl: they are the established terms in German and Dutch academic CVs too.
  ...
  "cv.section.teaching": { en: "Teaching", de: "Lehre", nl: "Onderwijs" },
  ...
  // Research focus, taken from Jonas's CV of July 2026 so the site and the
  // application dossier describe the work in the same terms. Lives here rather
  // than as a constant in cv.ts because it has to be translated.
  "academic.research": {
    en: "Research on data-driven marketing decision making, combining experimental and econometric methods with digital and immersive technologies such as artificial intelligence, augmented reality, and virtual reality. Through DEXLab and the LIT Network, building research and innovation infrastructures that connect academia, industry, and small and medium-sized enterprises.",
    de: "Forschung zu datengetriebenen Marketingentscheidungen, die experimentelle und ökonometrische Methoden mit digitalen und immersiven Technologien wie künstlicher Intelligenz, Augmented Reality und Virtual Reality verbindet. Mit dem DEXLab und dem LIT Network Aufbau von Forschungs- und Innovationsinfrastrukturen, die Wissenschaft, Industrie und kleine und mittlere Unternehmen zusammenbringen.",
    nl: "Onderzoek naar datagedreven marketingbeslissingen, waarbij experimentele en econometrische methoden worden gecombineerd met digitale en immersieve technologieën zoals kunstmatige intelligentie, augmented reality en virtual reality. Via DEXLab en het LIT Network bouwen aan onderzoeks- en innovatie-infrastructuren die wetenschap, industrie en het mkb met elkaar verbinden.",
  },
  ...
  "speakingPage.talksTitle": {
    en: "Signature Talks",
    de: "Ausgewählte Vorträge",
    nl: "Uitgelichte lezingen",
  },
  ...
  "consulting.training.desc": {
    ...
    de: "Programme für Führungsteams und Fachkräfte — von Digital Strategy auf MBA-Niveau bis zu maßgeschneiderten Inhouse-Curricula, u. a. für Allianz, APG und das niederländische Ministerium für I&W.",
